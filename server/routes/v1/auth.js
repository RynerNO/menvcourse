...
authRouter.post('/password/reset', forgotPasswordValidator ,authController.forgotPassword);

authRouter.post('/passwprd/reset/:token', resetPasswordValidator ,authController.resetPassword);

authRouter.post('/email/confirm', emailConfirmValidator, authController.emailConfirm);

authRouter.post('/email/resend', authMiddleware, authController.resendConfirmationEmail)
